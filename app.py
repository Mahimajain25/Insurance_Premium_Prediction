...
from insurance.constant import CONFIG_DIR, get_current_timestamp
...
def train():
    message = ""
    pipeline = Pipeline(config=Configuration(current_timestamp = get_current_timestamp()))
...
def predict():
    ...
    if request.method == 'POST':
        ...
        insurance_df = insurance_data.get_housing_input_data_frame()
