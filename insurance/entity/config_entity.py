...
['dataset_download_url','zip_download_data','raw_data_dir','ingested_train_dir','ingested_test_dir'])
...
DataTransformationConfig = namedtuple("DataTransformationConfig", ["smoker_cat",
